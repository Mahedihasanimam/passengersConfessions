            ...
            <div className=" rounded-lg p-6 h-full w-full ">
                ...
                <div className="space-x-[40px] flex items-center justify-center mt-20  ">
                    ...
                    <div className="border rounded-lg p-4 bg-white w-full max-w-[330px]">
                        ...
                        <p className="text-tertiary mb-2 py-4 font-semibold ">Dive into exclusive monthly stories &enjoy discounts on your favorite reads.</p>
                        <ul className=" pl-5  text-[#262626] space-y-4">
                            <li className='flex items-center space-x-2'><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.1 14.6L16.15 7.55L14.75 6.15L9.1 11.8L6.25 8.95L4.85 10.35L9.1 14.6ZM10.5 20C9.11667 20 7.81667 19.7375 6.6 19.2125C5.38333 18.6875 4.325 17.975 3.425 17.075C2.525 16.175 1.8125 15.1167 1.2875 13.9C0.7625 12.6833 0.5 11.3833 0.5 10C0.5 8.61667 0.7625 7.31667 1.2875 6.1C1.8125 4.88333 2.525 3.825 3.425 2.925C4.325 2.025 5.38333 1.3125 6.6 0.7875C7.81667 0.2625 9.11667 0 10.5 0C11.8833 0 13.1833 0.2625 14.4 0.7875C15.6167 1.3125 16.675 2.025 17.575 2.925C18.475 3.825 19.1875 4.88333 19.7125 6.1C20.2375 7.31667 20.5 8.61667 20.5 10C20.5 11.3833 20.2375 12.6833 19.7125 13.9C19.1875 15.1167 18.475 16.175 17.575 17.075C16.675 17.975 15.6167 18.6875 14.4 19.2125C13.1833 19.7375 11.8833 20 10.5 20Z" fill="#FF0048" />
                            </svg>
                                <span>Exclusive monthly story access</span></li>

                            <li className='flex items-center space-x-2'><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 2C18.03 2 22.5 6.47 22.5 12C22.5 17.53 18.03 22 12.5 22C6.97 22 2.5 17.53 2.5 12C2.5 6.47 6.97 2 12.5 2ZM16.09 7L12.5 10.59L8.91 7L7.5 8.41L11.09 12L7.5 15.59L8.91 17L12.5 13.41L16.09 17L17.5 15.59L13.91 12L17.5 8.41L16.09 7Z" fill="#6D6D6D" />
                            </svg>
                                <span> 10% discount for all products</span></li>
                            <li className='flex items-center space-x-2'><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.1 14.6L16.15 7.55L14.75 6.15L9.1 11.8L6.25 8.95L4.85 10.35L9.1 14.6ZM10.5 20C9.11667 20 7.81667 19.7375 6.6 19.2125C5.38333 18.6875 4.325 17.975 3.425 17.075C2.525 16.175 1.8125 15.1167 1.2875 13.9C0.7625 12.6833 0.5 11.3833 0.5 10C0.5 8.61667 0.7625 7.31667 1.2875 6.1C1.8125 4.88333 2.525 3.825 3.425 2.925C4.325 2.025 5.38333 1.3125 6.6 0.7875C7.81667 0.2625 9.11667 0 10.5 0C11.8833 0 13.1833 0.2625 14.4 0.7875C15.6167 1.3125 16.675 2.025 17.575 2.925C18.475 3.825 19.1875 4.88333 19.7125 6.1C20.2375 7.31667 20.5 8.61667 20.5 10C20.5 11.3833 20.2375 12.6833 19.7125 13.9C19.1875 15.1167 18.475 16.175 17.575 17.075C16.675 17.975 15.6167 18.6875 14.4 19.2125C13.1833 19.7375 11.8833 20 10.5 20Z" fill="#FF0048" />
                            </svg>  <span>Early access to new release</span></li>
                            <li className='flex items-center space-x-2'><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.5 2C18.03 2 22.5 6.47 22.5 12C22.5 17.53 18.03 22 12.5 22C6.97 22 2.5 17.53 2.5 12C2.5 6.47 6.97 2 12.5 2ZM16.09 7L12.5 10.59L8.91 7L7.5 8.41L11.09 12L7.5 15.59L8.91 17L12.5 13.41L16.09 17L17.5 15.59L13.91 12L17.5 8.41L16.09 7Z" fill="#6D6D6D" />
                            </svg>
                                <span>Member only newsletter</span></li>
                            <li className='flex items-center space-x-2'><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M9.1 14.6L16.15 7.55L14.75 6.15L9.1 11.8L6.25 8.95L4.85 10.35L9.1 14.6ZM10.5 20C9.11667 20 7.81667 19.7375 6.6 19.2125C5.38333 18.6875 4.325 17.975 3.425 17.075C2.525 16.175 1.8125 15.1167 1.2875 13.9C0.7625 12.6833 0.5 11.3833 0.5 10C0.5 8.61667 0.7625 7.31667 1.2875 6.1C1.8125 4.88333 2.525 3.825 3.425 2.925C4.325 2.025 5.38333 1.3125 6.6 0.7875C7.81667 0.2625 9.11667 0 10.5 0C11.8833 0 13.1833 0.2625 14.4 0.7875C15.6167 1.3125 16.675 2.025 17.575 2.925C18.475 3.825 19.1875 4.88333 19.7125 6.1C20.2375 7.31667 20.5 8.61667 20.5 10C20.5 11.3833 20.2375 12.6833 19.7125 13.9C19.1875 15.1167 18.475 16.175 17.575 17.075C16.675 17.975 15.6167 18.6875 14.4 19.2125C13.1833 19.7375 11.8833 20 10.5 20Z" fill="#FF0048" />
                            </svg>  <span>Access to All- Exclusive Polls</span></li>
                        </ul>
                        <div className='flex items-center justify-center pt-[32px] pb-[20px]'>
                            <p className="text-5xl font-bold mt-4 ">$50</p><span className='text-xs font-bold text-[#262626]'>/month</span>

                        </div>
                        <Button type="primary" style={{ backgroundColor: "#FF0048", color: "white", height: "44px", fontSize: '16px', fontWeight: 'bold' }} className="w-full border-none text-white px-6 py-2 rounded-lg">
                            Subscribe
                        </Button>
                    </div>
                    ...
                    <div className="border rounded-lg p-4 bg-white w-full max-w-[330px]">
                        ...
                        <div className='flex items-center justify-center pt-[32px] pb-[20px]'>
                            <p className="text-5xl font-bold mt-4 ">$150</p><span className='text-xs font-bold text-[#262626]'>/month</span>
                ...
                <div className="flex-shrink-0 w-fit   ">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                            ...
                            <div className='flex items-center justify-center space-x-2 pt-2'>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_41_113)">
                                        <path d="M16 2.5H2C1.46957 2.5 0.960859 2.71071 0.585786 3.08579C0.210714 3.46086 0 3.96957 0 4.5L0 13.5C0 14.0304 0.210714 14.5391 0.585786 14.9142C0.960859 15.2893 1.46957 15.5 2 15.5H16C16.5304 15.5 17.0391 15.2893 17.4142 14.9142C17.7893 14.5391 18 14.0304 18 13.5V4.5C18 3.96957 17.7893 3.46086 17.4142 3.08579C17.0391 2.71071 16.5304 2.5 16 2.5Z" fill="#EEEEEE" />
                        ...
                        <div className="rounded-md lg:max-w-[100px] md:max-w-[100px] w-full bg-gray-100 border border-[#F6F6F6] p-2">
                            ...
                            <div className='flex items-center justify-center space-x-2 pt-2'>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M18 13.5C18 14.0304 17.7893 14.5391 17.4142 14.9142C17.0391 15.2893 16.5304 15.5 16 15.5H2C1.46957 15.5 0.960859 15.2893 0.585786 14.9142C0.210714 14.5391 0 14.0304 0 13.5V4.5C0 3.96957 0.210714 3.46086 0.585786 3.08579C0.960859 2.71071 1.46957 2.5 2 2.5H16C16.5304 2.5 17.0391 2.71071 17.4142 3.08579C17.7893 3.46086 18 3.96957 18 4.5V13.5Z" fill="#C60A1D" />
                                    <path d="M0 6H18V12H0V6Z" fill="#FFC400" />
                                    <path d="M4.5 8.5V10C4.5 10.3978 4.65804 10.7794 4.93934 11.0607C5.22064 11.342 5.60218 11.5 6 11.5C6.39782 11.5 6.77936 11.342 7.06066 11.0607C7.34196 10.7794 7.5 10.3978 7.5 10V8.5H4.5Z" fill="#EA596E" />
                                    <path d="M6 8H7.5V9.5H6V8Z" fill="#F4A2B2" />
                                    <path d="M4.5 8H6V9.5H4.5V8Z" fill="#DD2E44" />
                                    <path d="M6 8C6.82843 8 7.5 7.66421 7.5 7.25C7.5 6.83579 6.82843 6.5 6 6.5C5.17157 6.5 4.5 6.83579 4.5 7.25C4.5 7.66421 5.17157 8 6 8Z" fill="#EA596E" />
                                    <path d="M6 7.25C6.82843 7.25 7.5 7.08211 7.5 6.875C7.5 6.66789 6.82843 6.5 6 6.5C5.17157 6.5 4.5 6.66789 4.5 6.875C4.5 7.08211 5.17157 7.25 6 7.25Z" fill="#FFAC33" />
