...
import { PhoneOutlined, MailFilled } from "@ant-design/icons";
                    ...
                    <div className="flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                        ...
                        <div className="lg:w-1/3 text-sm font-normal space-y-4">
                            ...
                            <div className="text-decriptioncolor text-[16px] font-normal space-y-2 pt-2">
                                <div>
                                    ...
                                    <span className="text-decriptioncolor">+(00)-000-000-0000</span>
                                </div>
                                <div className="pl-2">
                                    <MailFilled className="text-[16px] text-decriptioncolor pr-2" />
                                    <span className="text-decriptioncolor">infoname@mail.com</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 text-sm gap-x-3 gap-y-8 lg:w-2/3 w-full">
                            ...
                            <div className="space-y-3 text-start">
                                <h3 className="font-semibold text-[18px] pb-3 text-white">Programs</h3>
                                <div className="gap-6">
                            ...
                            <div className="space-y-3 text-start">
                                <h3 className="font-semibold text-[18px] pb-3 text-white">Help & Support</h3>
                                <div className="gap-6">
                                    <ul className="space-y-[12px] text-decriptioncolor font-medium text-sm">
                                        <li>
                            ...
                            <div className="space-y-[24px] text-start">
                                <h3 className="font-semibold text-[18px] pb-3 text-white">Social Media</h3>
                                <div className="gap-6">
                                    <ul className="space-y-[12px] text-decriptioncolor font-medium text-sm flex items-center space-x-4">
                                        <li className="pt-4">
                                            <Link to={'https://www.facebook.com'}>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M24 12.0938C24 5.46638 18.6274 0.09375 12 0.09375C5.37262 0.09375 0 5.46638 0 12.0938C0 18.0833 4.38825 23.0478 10.125 23.948V15.5625H7.07812V12.0938H10.125V9.45C10.125 6.4425 11.9166 4.78125 14.6576 4.78125C15.9705 4.78125 17.3438 5.01563 17.3438 5.01563V7.96875H15.8306C14.3399 7.96875 13.875 8.89378 13.875 9.84281V12.0938H17.2031L16.6711 15.5625H13.875V23.948C19.6117 23.0478 24 18.0833 24 12.0938Z" fill="#1877F2" />
                                                </svg>
                                        ...
                                        <li>
                                            <Link to={'https://whatsapp.com'}>
                                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <defs>
                                                        <linearGradient id="paint0_linear_58_305" x1="1158.85" y1="2327.71" x2="1158.85" y2="0.41748" gradientUnits="userSpaceOnUse">
                                                            <stop stop-color="#1FAF38" />
                                                            <stop offset="1" stop-color="#60D669" />
                                                        </linearGradient>
                                                        <linearGradient id="paint1_linear_58_305" x1="1200" y1="2410.75" x2="1200" y2="0" gradientUnits="userSpaceOnUse">
