...
import { Form, Input, Button, Checkbox, message, Space, Alert, Divider } from "antd";
        ...
        <div className=" lg:flex md:flex flex-row items-center justify-between max-w-6xl mx-auto min-h-screen  ">
            ...
            <div className="max-w-lg w-full  mx-auto px-4 bg-[#FFFFFF]  border p-4 rounded-xl shadow-md">
                ...
                <div className="text-center pb-[34px]">
                    <h1 className="text-4xl font-bold mb-4 text-secondary">Become An Affiliate</h1>
                    <h3 className="text-tertiary text-[16px] max-w-sm mx-auto">
                    If you want to make money, please fill up the  information for sign in
                    </h3>
                </div>
                    ...
                    >
                        ...
                        >
                            <Input
                                ...
                                className="border border-[#D0D5DD] h-[44px] border-none bg-[#FFE5ED4D] hover:bg-[#FFE5ED4D] p-2 text-[16px] text-[#667085] font-normal hover:border-[#D0D5DD] focus:border-[#FFCCDA]"
                        ...
                        >
                            <Input.Password
                                ...
                                className="border border-[#D0D5DD] h-[44px] border-none bg-[#FFE5ED4D] hover:bg-[#FFE5ED4D] p-2 text-[16px] text-[#667085] font-normal  focus:border-[#ff4375] "
                        ...
                        <p className="text-[16px] font-semibold text-secondary text-center ">By continuing you agree to Passengers& Confession's <Link to={'/termsAndConditions'} className="text-[16px] font-semibold text-primary hover:text-primary pt-1 w-fit "> Terms & conditions</Link> & <Link to={'/termsAndConditions'} className="text-[16px] font-semibold text-primary hover:text-primary pt-1 w-fit "> Privacy policy</Link> <Link to="/auth/login" className="text-[16px] font-semibold text-primary hover:text-primary pt-1 w-fit "> Sign in</Link></p>


                        <Divider style={{color:'#B0B0B0'}}>New to Passengers Confessions?</Divider>
                       <Link to={'/auth/signup'}>
                       <Button type="primary" htmlType="submit" style={{ backgroundColor: "#FFFFFF", color: "#FF0048", height: "44px", fontSize: '16px', fontWeight: 'bold',border:'2px solid #D1D1D1' }} className="w-full border-none text-white px-6 py-2 rounded-lg">
                        Create a new acount
                            </Button>
                       </Link>
                    </Form>
                    ...
                    style={{marginTop:'10px'}}
                        ...
                        message={
                            <div>
                                ...
                                <p>Accessing this content requires age verification and consent. You are not allowed to register If you are under 18.</p>
                            </div>
                        }
                        type="error"
                        showIcon
