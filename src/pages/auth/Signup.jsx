...
import { Form, Input, Button, Checkbox, message, Space, Alert } from "antd";
            ...
            <div className="max-w-lg w-full  mx-auto px-4 ">
                ...
                <div className="text-center pb-[34px]">
                    ...
                    <h3 className="text-tertiary text-[16px] max-w-sm mx-auto">
                        Fill up some information to create a new account in Passenger Confession
                    </h3>
                </div>
                <div className="flex justify-center items-center">
                    ...
                    >
                        ...
                        <p className="text-[16px] font-semibold text-secondary text-center ">Have an account? <Link to="/auth/login" className="text-[16px] font-semibold text-primary hover:text-primary pt-1 w-fit "> Sign in</Link></p>
                    </Form>
                </div>
                {showAlert && (
                    <Alert
