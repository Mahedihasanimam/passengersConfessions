        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Highest you can earn on level 1 is
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Highest you can earn on level 2 is
              <strong> $1.5M</strong>
            </p>
            <p className="mt-4 text-gray-500">
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Highest you can earn on level 3 is <strong> $5M</strong>
            </p>
            <p className="mt-4 text-gray-500">
          ...
          >
            ...
            <p className="mt-2 text-gray-600">
              Highest you can earn on level 4 is <strong> $14M</strong>
            </p>
            <p className="mt-4 text-gray-500">
