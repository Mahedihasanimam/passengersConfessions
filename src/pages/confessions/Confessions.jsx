    ...
    return (
        <div className="container mx-auto px-4 pt-6 pb-[80px]">
            <div className='pb-6'>
               ...
               <Button   onClick={() => navigate('/addConfession')} type="primary" style={{backgroundColor: "#FF0048", color: "white",height: "35px",fontSize:'16px',fontWeight:'bold'}}  className="w-fit border-none text-white px-6 py-2 rounded-full">
               Add yours
        </Button>
               </div>
              ...
              <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center rounded-md">
                ...
                >
                  <svg width="36" height="46" viewBox="0 0 36 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.875 39.73C16.235 39.73 17.3842 39.2608 18.3225 38.3225C19.2608 37.3825 19.73 36.2333 19.73 34.875V24.925H26.5575V21.075H17.8075V31.2925C17.4142 30.8642 16.9725 30.545 16.4825 30.335C15.9942 30.125 15.4583 30.02 14.875 30.02C13.5167 30.02 12.3675 30.4892 11.4275 31.4275C10.4892 32.3675 10.02 33.5167 10.02 34.875C10.02 36.2333 10.4892 37.3825 11.4275 38.3225C12.3675 39.2608 13.5167 39.73 14.875 39.73ZM4.54 45.5C3.38833 45.5 2.4275 45.115 1.6575 44.345C0.8875 43.575 0.501667 42.6142 0.5 41.4625V4.5375C0.5 3.3875 0.885833 2.4275 1.6575 1.6575C2.42917 0.8875 3.39 0.501667 4.54 0.5H24.25L35.5 11.75V41.4625C35.5 42.6125 35.115 43.5733 34.345 44.345C33.575 45.1167 32.6133 45.5017 31.46 45.5H4.54ZM23 13H33L23 3V13Z" fill="#B0B0B0" fill-opacity="0.8" />
                  </svg>
