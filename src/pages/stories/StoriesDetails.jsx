...
import { useGetStoryByIdQuery } from "../../../redux/apiSlices/stroeisApiSlices";
...
const StoriesDetails = () => {
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = useGetStoryByIdQuery(params.id);
  const {
    data: allComments,
    ...
    <div className="container mx-auto p-6 rounded-lg min-h-[60vh]">
      {isFetching || isLoading || commentIsFetching || commentIsLoading ? (
        ...
        <>
          ...
          {Confession?.data?.storyVideoUrl && user?.isPremiumSubscribed && (
          ...
          <div className="lg:flex flex-row items-center justify-between gap-4">
            <div className=" h-[40vh]">
              {isVideoMode ? (
                ...
                >
                  <source
                    src={imageUrl + Confession?.data?.storyVideoUrl}
                    type="video/mp4"
                  />
                  ...
                  <div className="w-full mt-3">
                    {!isVideoMode && (
                      <AudioPlayer
                        ...
                        src={imageUrl + Confession?.data?.storyAudioUrl}
                      />
                    )}
                  </div>
                )}
